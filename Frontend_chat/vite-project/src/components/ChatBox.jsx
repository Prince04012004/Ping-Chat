  ...
  return (
    <>
      ...
      <div id="chat-master-container" style={{ fontFamily: config?.font }}>
        ...
        <div className="sticky top-0 flex-shrink-0 w-full h-[70px] flex items-center justify-between px-5 bg-black/80 backdrop-blur-3xl border-b border-white/5 z-50">
          ...
          <div className="flex items-center gap-4">
            ...
            <div onClick={openProfile} className="flex items-center gap-3 cursor-pointer">
              ...
              <div className="w-11 h-11 rounded-2xl border-2 overflow-hidden bg-black"
                style={{borderColor:hexToRGBA(accentColor,0.2)}}>

                {receiverPic ? (
                  <img src={receiverPic} className="w-full h-full object-cover"/>
                ) : (
        ...
        {/* INPUT */}
        <div className="sticky bottom-0 p-5 bg-black/40 backdrop-blur-3xl border-t border-white/5">
